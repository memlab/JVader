...
__all__ = ['GausMixHMM', 'mfcc', 'voicedEndpoints_ns', 'voicedEndpoints', 'soundSamplingRate', 'soundNumFrames', 'loadSpeech', 'train', 'trainDirs', 'saveModels', 'loadModels', 'loadGarbageModel', 'classify', 'ix2ms', 'ms2ix', 'decimate', 'PYWR_GARBAGE_LABEL']
